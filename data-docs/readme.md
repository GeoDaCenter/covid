...
|New York Times|Cases and Deaths|[📄](http://www.github.com/GeoDaCenter/covid/data-docs/data-docs/nytimes.md)|[🔗](https://github.com/nytimes/covid-19-data)|[👩‍💻](https://github.com/GeoDaCenter/covid/tree/master/data-scripts/nyt)||
|CDC|Testing Positivity and Testing Capacity, Vaccine Doses Administered and Distributed|[📄](http://www.github.com/GeoDaCenter/covid/data-docs/data-docs/nytimes.md)|[🔗](https://covid.cdc.gov/covid-data-tracker/#county-view)|[👩‍💻](https://github.com/GeoDaCenter/covid/tree/master/data-scripts/cdc)||
...
|County Health Rankings| Percent Uninsured, Percent Over 65 Years Old, Life Expectancy, and other Social Determinants of Health|[📄](http://www.github.com/GeoDaCenter/covid/data-docs/data-docs/county-health-rankings.md)|[🔗](https://www.countyhealthrankings.org/)|||
|American Community Survey|Population|[📄](http://www.github.com/GeoDaCenter/covid/data-docs/data-docs/acs.md)|[🔗](https://www.census.gov/programs-surveys/acs)|||
...
| Dataset | Variables | Data Docs | Source Link | Data Scripts | API Access | 
|:---------|:-----|:-----|:-----|:-----|:------|
|Covid Tracking Project|State Level Testing Positivity and Capacity, Confirmed Cases Per Testing Positive (CCPT)|[📄](http://www.github.com/GeoDaCenter/covid/data-docs/data-docs/covid-tracking-project.md)|[🔗](https://covidtracking.com/)|[👩‍💻](https://github.com/GeoDaCenter/covid/tree/master/data-scripts/cdc)||
