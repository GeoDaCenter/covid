...
def fetch_testing_data_state():
    ...
    testing_url = "https://raw.githubusercontent.com/GeoDaCenter/covid-atlas-research/master/Testing_Data/python/state_testing.csv?token=AL7MVTADGXWTQCN74CAGXTK7QNJCQ"
    download_data(testing_url, working_dir, 'testing_state_raw.csv')

    positivity_url = "https://raw.githubusercontent.com/GeoDaCenter/covid-atlas-research/master/Testing_Data/python/state_positivity.csv?token=AL7MVTADGXWTQCN74CAGXTK7QNJCQ"
...
def wide_to_long_state():
    ...
    pd.write_csv(df, "testing_state_raw.csv")
    ...
    pd.write_csv(dp, "state_positivity_raw.csv")
