...
try:
    ...
    s3.Object('geoda-covid-atlas', 'counties_update_processing.geojson').put(Body=open(os.path.join(repo_root, 'data/counties_update.geojson'), 'rb'))
    s3.Object('geoda-covid-atlas', 'states_update_processing.geojson').put(Body=open(os.path.join(repo_root, 'data/states_update.geojson'), 'rb'))
