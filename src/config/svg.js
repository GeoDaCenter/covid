...
export const plus = <svg viewBox="0 0 100 100" >
            <g>
                <polygon  points="43.1,17.2 56.9,17.2 56.9,42.6 80,42.6 80,57.4 56.9,57.4 56.9,82.8 43.1,82.8 43.1,57.4 20,57.4 
                    20,42.6 43.1,42.6 	"/>
            </g>
    </svg>
...
export const addData = <svg viewBox="0 0 98.07 70.77"><path d="M89.26,41V32A17.5,17.5,0,0,0,71.75,14.48H18.38A17.5,17.5,0,0,0,.87,32V46.42A17.5,17.5,0,0,0,18.38,63.93H49.7A24.73,24.73,0,1,0,89.26,41Zm-15,38.12A18.55,18.55,0,1,1,92.76,60.53,18.6,18.6,0,0,1,74.22,79.08Z" transform="translate(-0.87 -14.48)"/><path class="cls-1" d="M85.14,57.44H77.31V49.61a3.09,3.09,0,0,0-6.18,0v7.83H63.3a3.09,3.09,0,0,0,0,6.18h7.83v7.83a3.09,3.09,0,1,0,6.18,0V63.62h7.83a3,3,0,0,0,3.09-3.09A3.1,3.1,0,0,0,85.14,57.44Z" transform="translate(-0.87 -14.48)"/></svg>
export const arrow = <svg viewBox="0 0 100 100" ><g><path d="M31.3,97.5c-2.6,0-5.1-1-7.1-2.9c-3.9-3.9-3.9-10.3,0-14.2L54.5,50L24.2,19.6c-3.9-3.9-3.9-10.3,0-14.2    c3.9-3.9,10.3-3.9,14.2,0l37.5,37.5c1.9,1.9,2.9,4.4,2.9,7.1s-1.1,5.2-2.9,7.1L38.4,94.6C36.4,96.5,33.8,97.5,31.3,97.5z"></path></g></svg>
