...
// if (
//   selectedDate in lisaData[selectedDataset] &&
//   field in lisaData[selectedDataset][selectedDate]
// ) {
...
//   }
//   if (!(selectedDate in lisaData[selectedDataset]))
//     lisaData[selectedDataset][selectedDate] = {};
//   if (!(field in lisaData[selectedDataset][selectedDate]))
//     lisaData[selectedDataset][selectedDate][field] = {};
