...
import { NavBar, Geocoder, HeroMap, Footer, FastTrackInsights } from '../../components';
                    ...
                    <Hero>
                        ...
                        <Grid container spacing={1}>
                            ...
                            <Grid item xs={12} md={5} style={{display:'flex',alignItems:"center"}}> 
                                <p>
                                    The US COVID Atlas is a visualization tool led by a <br className="desktop-only" /><b>University of Chicago research coalition.</b>
                                    <br/><br/>
                                    <span className="desktop-only">In a quickly changing pandemic landscape, our tool connects COVID case data and community indicators 
