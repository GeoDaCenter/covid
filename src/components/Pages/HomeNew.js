        ...
        <Hero>
          ...
          <Grid container spacing={1}>
            ...
            <Grid item xs={12} md={5}>
              <p>
                The US COVID Atlas is a visualization tool led by a <br />
        ...
        <Features>
          <Grid container spacing={1}>
            ...
            <Feature item xs={12} md={3}>
              ...
              <p>
                Statistical clusters of both confirmed and daily new COVID cases
                &amp; deaths, with and without population adjustment.
              </p>
            </Feature>
            <Feature item xs={12} md={3}>
              <img
              ...
              <p>
                Watch the spread of accumulated or daily new COVID cases using a
                time slider and live time-animation.
              </p>
            </Feature>
            <Feature item xs={12} md={3}>
              <img
          ...
          <UseCases>
            <Grid container spacing={5}>
              ...
              <Grid item xs={12} md={6}>
                ...
                <p>
                  Use spatial statistics to detect hot spots with raw case data
                  or by adjusting for population. Because of the infectious
                  nature of COVID, high numbers of cases anywhere will be of
                  concern. At the same time, identifying areas that have a
                  disporotionately high number of cases within the population is
                  necessary to locate areas hit hardest by the pandemic.
                </p>
              </Grid>
              <Gutter h={80} />
              <Grid item xs={12} md={6}>
                ...
                <p>
                  ...
                  button and watch the spread of COVID. Analyze patterns of the
                  spread to support planning for resource allocation.
                </p>
              </Grid>
              <Grid item xs={12} md={6}>
                <img
              ...
              <Grid item xs={12} md={6}>
                ...
                <p>
                  ...
                  choropleth maps) to find COVID at a local level. Then, select
                  and track hotspots over time using the Local Moran's I
                  statistic. Use a powerful visual analytic tool to find COVID
                  spillovers along state borders, emerging from one county to
              ...
              <Grid item xs={12} md={6}>
                ...
                <p>
                  ...
                  segregated cities or Native American Reservation boundaries to
                  identify uniquely vulnerable locales.
                </p>
              </Grid>
              <Grid item xs={12} md={6}>
                <img
              ...
              <Grid item xs={12} md={6}>
                ...
                <p>
                  ...
                  continue to grow and spillover nearby counties, the areas will
                  turn red. Mature hotspots are clusters of counties that remain
                  red over time and continue to grow.
                </p>
              </Grid>
            </Grid>
          </UseCases>
