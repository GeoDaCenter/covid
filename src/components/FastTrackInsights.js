        ...
        if (props.active) {
            ...
            return (
                ...
                <p style={{color:'white', padding:'5px 0 0 0',}}>{data[0].payload.date}</p>
                    {data.map(data => 
                        <p style={{color: data.color, padding:'5px 0 0 0', textShadow: `2px 2px 4px ${colors.black}`, fontWeight:600}}>
                            {data.name === 'dailyNew' ? 'Daily New Cases' : data.name === 'dailyFull' ? 'Daily New Fully Vaccinated' : data.name}: {Number.isInteger(Math.floor(data.payload[data.dataKey])) ? 
                    ...
                    <SummaryItem>
                        <Grid container spacing={5}>
                            ...
                            <Grid item xs={12} md={3}>
                                <TextContainer>
                                    <h3 className="metricTitle">
                                        Week Over Week<br/> Average Change
                                    </h3>
                                </TextContainer>
                                <TextContainer>
                                    <h4>
                    ...
                    <SummaryItem>
                        <Grid container spacing={5}>
                            ...
                            <Grid item xs={12} md={3}>
                                ...
                                <TextContainer>
                                    <h4>
                                        {summary.vaccination.summary.oneOrMorePct}%
                                    </h4>
                                </TextContainer>
                            </Grid>
                            <Grid item xs={12} md={3}>
                    ...
                    <SummaryItem>
                        <Grid container spacing={5}>
                            <Grid item xs={12} md={4}>
                                <TextContainer>
                                    <h3 className="metricTitle">
                                        Deaths Per 100k People in Counties with the most Essential Workers (75%)
                                    </h3>
                                </TextContainer>
                                    <TextContainer>
                                    <h4>
                                        {summary.equity.quartileEssentialDeathsPer100k}
                                    </h4>
                                </TextContainer>
                            </Grid>
                            <Grid item xs={12} md={6}>
                                <TextContainer>
                                    <h3 className="metricTitle">
                                        Difference vs National Average<br/><br/>
                                    </h3>
                                </TextContainer>
                                <TextContainer>
                                    <h4>
                                        {summary.equity.quartileEssentialPct > 0 ? '+' : '-'}{summary.equity.quartileEssentialPct}%
                                    </h4>
                                </TextContainer>
                            </Grid>
                        </Grid>
