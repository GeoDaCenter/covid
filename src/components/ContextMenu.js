...
//     props.active ? colors.lightblue : colors.white} !important;
//   .MuiButton-label {
//     // font-size:75%;
//     text-transform: none;
//   }
...
//     element.parentNode.id === 'contextMenu' ||
//     element.parentNode.id === 'mainContainer'
//   ) {
...
//       document.addEventListener('touchstart', removeListener, {
//         passive: true,
//       });
//     }
//   }, [panelState.context]);
...
//           onClick={() =>
//             dispatch(
//               setPanelState({ variables: panelState.variables ? false : true }),
//             )
//           }
//         >
//           {SVG.settings}
...
//           onClick={() =>
//             dispatch(setPanelState({ info: panelState.info ? false : true }))
//           }
//         >
//           {SVG.report}
//         </Contextbutton>
...
//           onClick={() =>
//             dispatch(
//               setPanelState({ lineChart: panelState.lineChart ? false : true }),
//             )
//           }
//         >
//           {SVG.chart}
...
//           onClick={() =>
//             dispatch(
//               setPanelState({ tutorial: panelState.tutorial ? false : true }),
//             )
//           }
//         >
//           {SVG.info}
